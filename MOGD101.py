...
if __name__ == '__main__':
    ...
    print("Best 0:", results[2][0])
    print("Best 1:", results[2][1])
    print("Best 2:", results[2][2])
    print("Best 3:", results[2][3])
    print("Best 4:", results[2][4])
    print("hof 0 :", my_evaluate(results[2][0]))
