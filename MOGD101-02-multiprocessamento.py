...
def my_evaluate(individual):
    ...
    ## --
    return (fitness4 * 1000), (fitness * 1000), (fitness3 * 1000), (fitness2 * 1000),
...
def main():
    ...
    pop, log = algorithms.eaSimple(pop, toolbox, cxpb=0.9, mutpb=0.005, ngen=15000,
...
if __name__ == '__main__':
    ...
    for i in range(100):
        ...
        print("hof  "+str(i)+" : "+ str( my_evaluate(results[2][i])))
