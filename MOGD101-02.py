...
def my_evaluate(individual):
    ...
    ## --
    return (fitness * 1000), (fitness4 * 1000), (fitness3 * 1000), (fitness2 * 1000),
...
def main():
    ...
    pop, log = algorithms.eaSimple(pop, toolbox, cxpb=0.9, mutpb=0.01, ngen=100000,
...
if __name__ == '__main__':
    ...
    for i in range(100):
        print("Best "+str(i)+" : "+str(results[2][i]) )
        print("hof  "+str(i)+" : "+ str( my_evaluate(results[2][0])))
    print("hof 1 :", my_evaluate(results[2][1]))
    print("hof 2 :", my_evaluate(results[2][2]))
    print("hof 3 :", my_evaluate(results[2][3]))
    print("hof 4 :", my_evaluate(results[2][4]))
